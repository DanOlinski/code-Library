<?php
// this text is within a php block, you can write html outside of this block and it will behave like an html file
?>

<?php
//Paths; to reference a file use;  "include '<filename.php>';"
